...
namespace CaveBirdLabs.Forms.Platform.iOS
{
	public class CxPagedCarouselPageRenderer : CarouselPageRenderer
	{
		...
		{
			float width = _view.Frame.Width - (float)_pagedCarouselPage.PagerPadding.Left - (float)_pagedCarouselPage.PagerPadding.Right;
			...
			switch (_pagedCarouselPage.PagerXAlign)
			{
				...
				case TextAlignment.End:
					x = _view.Frame.Width - width - (float)_pagedCarouselPage.PagerPadding.Right;
					break;
			...
			switch (_pagedCarouselPage.PagerYAlign)
			{
				case TextAlignment.Center:
					...
					break;
				case TextAlignment.End:
					y = _view.Frame.Height - (float)_pagedCarouselPage.PagerPadding.Bottom - HEIGHT;
